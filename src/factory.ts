...
export function antfu(
  ...
  if (isInEditor == null) {
    ...
    if (isInEditor)
      ...
      console.log('[@ltteng/eslint-config] Detected running in editor, some rules are disabled.')
  }
  ...
  if ('files' in options) {
    throw new Error('[@ltteng/eslint-config] The first argument should not contain the "files" property as the options are supposed to be global. Place it in the second or later config instead.')
  }
