...
const isCwdInScope = isPackageExists('@ltteng/eslint-config')
 ...
 * @example
 * ```ts
 * import { renameRules } from '@ltteng/eslint-config'
 *
 * export default [{
 *   rules: renameRules(
 *     {
 ...
 * @example
 * ```ts
 * import { renamePluginInConfigs } from '@ltteng/eslint-config'
